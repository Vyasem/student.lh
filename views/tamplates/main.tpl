...
<header>
    ...
    {if ($smarty.session.auth === true || $smarty.cookies.auth == 1)}
    ...
    {else}
        ...
        <input type="text" name="LOGIN[LOGIN]" class="form-control {$additional['login_login']['STATUS']}" id="login_form_login" placeholder="Введите логин" value="{$smarty.post.LOGIN.LOGIN}">
